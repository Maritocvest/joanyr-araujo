...
const About = () => {
  return <section id="sobre" className="py-20 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            <img src="/lovable-uploads/84f01f80-0758-4aaa-8826-cfa491436452.png" alt="Joanyr Araujo - Advogado Previdenciarista" className="w-full max-w-lg mx-auto rounded-xl shadow-xl" />
          </div>
          <div className="lg:w-1/2">

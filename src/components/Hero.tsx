...
const Hero = () => {
  ...
  return <section id="inicio" className="relative min-h-screen flex items-center bg-primary overflow-hidden pt-16">
      ...
      <div className="container mx-auto px-4 md:px-6 py-16 flex flex-col lg:flex-row items-center">
        ...
        animationDelay: '0.4s'
          ...
          <div className="relative">
            ...
            <img src="/lovable-uploads/84f01f80-0758-4aaa-8826-cfa491436452.png" alt="Joanyr Araujo - Advogado Previdenciarista" className="relative w-72 h-72 md:w-96 md:h-96 rounded-full object-cover object-top border-4 border-secondary" />
          </div>
        </div>
      </div>
    </section>;
